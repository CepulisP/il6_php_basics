...
<header style="text-align:center;">
    ...
    <nav>
        <ul style="list-style-type: none">
            <li><a href='<?php echo BASE_URL ?>' style="color:white;text-decoration:none">&bullet; Home</a></li>
            <li><a href='<?php echo BASE_URL ?>catalog/all/' style="color:white;text-decoration:none">&bullet; All ads</a></li>
